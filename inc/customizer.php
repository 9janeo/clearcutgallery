	...
	function understrap_theme_customize_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'understrap_sidebar_addon',
				array(
					'label'             => __( 'Sidebar addon', 'understrap' ),
					'description'       => __(
						'Set sidebar\'s default addon. Can either be: right, left, both or none. Note: this can be overridden on individual pages.',
						'understrap'
					),
					'section'           => 'understrap_theme_layout_options',
					'settings'          => 'understrap_sidebar_addon',
					'type'              => 'select',
					'sanitize_callback' => 'understrap_theme_slug_sanitize_select',
					'choices'           => array(
						'right' => __( 'Right sidebar', 'understrap' ),
					...
					'priority'          => apply_filters( 'understrap_sidebar_addon_priority', 20 ),
				)
			)
		);
